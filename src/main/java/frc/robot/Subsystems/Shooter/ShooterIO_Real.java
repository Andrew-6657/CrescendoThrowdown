...
public ShooterIO_Real() {
    ...
    leftFlywheelConfig.CurrentLimits = ShooterConstants.LeftFlywheels.kCurrentConfigs; // Current Limits
...
//would this make changing the set point look like "changeRPMTarget(new FlywheelSetPoint(100,200));" or "changeRPMTarget(ShooterConstants.kSpeakerRPM);" ?
